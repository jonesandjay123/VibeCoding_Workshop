#!/usr/bin/env python3
"""Convert P1_slide_content.md to PowerPoint."""
...
# Parse the markdown
with open("/Users/jarvis/Downloads/code/VibeCoding_Workshop/session2/slides/P1_slide_content.md", "r") as f:
    content = f.read()
...
for block in blocks:
    ...
    if not block.startswith("## Slide") and not block.startswith("## 附錄"):
    ...
    slide_subtitle = ""
    for line in lines:
        if line.startswith("## Slide") or line.startswith("## 附錄"):
            # e.g. "## Slide 1 — 開場：你的網站還活著嗎？"
            parts = line.split("—", 1)
...
# Save
output_path = "/Users/jarvis/Downloads/code/VibeCoding_Workshop/session2/slides/Session2_VibeCoding.pptx"
